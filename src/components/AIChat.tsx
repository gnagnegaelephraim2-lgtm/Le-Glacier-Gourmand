      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-28 left-4 sm:left-8 z-50 w-[calc(100vw-2rem)] sm:w-[380px] h-[520px] max-h-[calc(100dvh-12rem)] glass rounded-3xl shadow-2xl flex flex-col overflow-hidden border-forest/10"
          >
            {/* Header */}
