    ...
    <>
      ...
      <div className="fixed bottom-8 left-6 z-50">
        <motion.button
          ...
          className="relative w-12 h-12 sm:w-16 sm:h-16 bg-forest text-white rounded-full shadow-2xl flex items-center justify-center"
        >
          {/* Pulse ring */}
          <motion.div
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="p-3 sm:p-5 bg-forest text-cream flex justify-between items-center flex-shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gold/20 flex items-center justify-center">
                  ...
                  <Sparkles size={20} className="text-gold hidden sm:block" />
                </div>
                <div>
            ...
            <div className="px-3 py-2 sm:px-5 sm:py-3 bg-gold/10 border-b border-forest/5 flex flex-col gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-3 sm:p-5 space-y-3 bg-cream/50">
              {messages.map((msg, i) => (
            ...
            {/* Input */}
            <div className="p-3 sm:p-4 bg-white border-t border-forest/10 flex gap-2 flex-shrink-0">
              <input
                ref={inputRef}
                type="text"
                value={input}
